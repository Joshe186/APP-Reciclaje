import axios from 'axios'
 ...
 export const register = (userData) => {
  return async (dispatch) => {
    try {
      const response = await axios.post('https://reciclaje.onrender.com/api/register', userData);
...
export const login = (email, password) => {
  return async (dispatch) => {
    try {
      const response = await axios.post("https://reciclaje.onrender.com/api/login", {
        email,
        password,
      });
...
export const AllCompany = (payload) => {
  return async (dispatch) => {
    try {
      const res = await axios.get('https://reciclaje.onrender.com/api/companys', payload);
      const data = res.data;
  ...
  return async (dispatch) => {
    try {
      const res = await axios.get(
        "https://reciclaje.onrender.com/api/datapersonal",
        {
          method: "GET",
          headers: {
            Authorization: `${token}`,
...
export const DeleteAccount = (token) => async (dispatch) => {
  try {
    const response = await fetch('https://reciclaje.onrender.com/api/deleteaccount', {
      method: 'DELETE',
      headers: {
        'Content-Type': 'application/json',
        Authorization: `${token}`,
...
export const postProduct = (payload) => {
  return async (dispatch) => {
    try {
      const res = await axios.post('https://reciclaje.onrender.com/post', payload);
      const data = res.data;
...
export const deleteProduct= (productId) => {
  return async (dispatch) => {
    try {
      const res = await axios.delete(`https://reciclaje.onrender.com/delete/${productId}`);
      const data = res.data;
      dispatch({
        type: "DELETE_PRODUCT",
        payload: data
...
export const AllUsers= (payload) => {
  return async (dispatch) => {
    try {
      const res = await axios.get('https://reciclaje.onrender.com/users', payload);
      const data = res.data;
...
export const ProductDetail= (productId) => {
  return async (dispatch) => {
    try {
      const res = await axios.get(`https://reciclaje.onrender.com/product/${productId}`);
      const data = res.data;
...
export const PaymentPaypal= (productId) => {
  return async (dispatch) => {
    try {
      const res = await axios.post(`https://reciclaje.onrender.com/create-payment/${productId}`);
      const data = res.data;
...
export const Order= (payload) => {
  return async (dispatch) => {
    try {
      const res = await axios.post(`https://reciclaje.onrender.com/order`, payload);
      const data = res.data;
      dispatch({
        type: "ORDER",
        payload: data
...
export const AllOrder= () => {
  return async (dispatch) => {
    try {
      const res = await axios.get(`https://reciclaje.onrender.com/orders`);
      const data = res.data;
      dispatch({
        type: "ALL_ORDER",
        payload: data
...
export const OneOrder= (orderId) => {
  return async (dispatch) => {
    try {
      const res = await axios.get(`https://reciclaje.onrender.com/order/${orderId}`);
      const data = res.data;
      dispatch({
        type: "DETAILS_ORDER",
        payload: data
...
export const deleteOrder= (orderId) => {
  return async (dispatch) => {
    try {
      const res = await axios.delete(`https://reciclaje.onrender.com/order/delete/${orderId}`);
      const data = res.data;
      dispatch({
        type: "DELETE_ORDER",
        payload: data
...
export const updateProduct= (productId, payload) => {
  return async (dispatch) => {
    try {
      const res = await axios.put(`https://reciclaje.onrender.com/productupdate/${productId}`, payload);
      const data = res.data;
      dispatch({
        type: "UPDATE_PRODUCT",
        payload: data
